...
**[ai-learnings](https://github.com/ghantakiran/ai-learnings)** (1 ⭐)
*Unknown*
...
**[AIML-EVOLUTION](https://github.com/poornimam0347-commits/AIML-EVOLUTION)** (1 ⭐)
*Jupyter Notebook*
...
**[Loan_Approval_prediction](https://github.com/Souparno467/Loan_Approval_prediction)** (2 ⭐)
*Jupyter Notebook*
...
**[-Credit-Card-Fraud-Detection-Using-Machine-Learning](https://github.com/Paulrithish27/-Credit-Card-Fraud-Detection-Using-Machine-Learning)** (1 ⭐)
*Python*
 Credit Card Fraud Detection Using Machine Learning 

**[rajesh-kakileti](https://github.com/rajeshkakileti0/rajesh-kakileti)** (1 ⭐)
*TypeScript*
Generative AI–Powered Machine Learning Learning System

**[-Heart-Stroke-Prediction-ML-Pipeline-Project-](https://github.com/CoderTanujSingh/-Heart-Stroke-Prediction-ML-Pipeline-Project-)** (1 ⭐)
*Jupyter Notebook*
Heart Stroke Risk Prediction using Machine Learning Pipeline

**[HPSG](https://github.com/qkrwnduf1997/HPSG)** (7 ⭐)
*Python*
...
**[Cell-Segmentation-Deep-Learning](https://github.com/BGill8/Cell-Segmentation-Deep-Learning)** (1 ⭐)
*Unknown*
Semantic Nuclei Cell Segmentation Project for AI535 Final Project

## 📈 Trending AI Projects

**[cloudbreak](https://github.com/hortonworks/cloudbreak)** (362 ⭐)
*Java*
...
**[wppconnect](https://github.com/wppconnect-team/wppconnect)** (3,107 ⭐)
*TypeScript*
WPPConnect is an open source project developed by the JavaScript community with the aim of exporting functions from WhatsApp Web to the node, which can be used to support the creation of any interaction, such as customer service, media sending, intelligence recognition based on phrases artificial and many other things, use your imagination

**[llama_sdk](https://github.com/Mobile-Artificial-Intelligence/llama_sdk)** (112 ⭐)
*C++*
lcpp is a dart implementation of llama.cpp used by the mobile artificial intelligence distribution (maid)

**[taranis-ai](https://github.com/taranis-ai/taranis-ai)** (924 ⭐)
*Python*
...
**[aiid](https://github.com/responsible-ai-collaborative/aiid)** (229 ⭐)
*JavaScript*
The AI Incident Database seeks to identify, define, and catalog artificial intelligence incidents.

**[awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai)** (11,450 ⭐)
*Unknown*
A curated list of modern Generative Artificial Intelligence projects and services

**[BOT-MMORPG-AI](https://github.com/ruslanmv/BOT-MMORPG-AI)** (168 ⭐)
*Jupyter Notebook*
...
**[AGiXT](https://github.com/Josh-XT/AGiXT)** (3,152 ⭐)
*Python*
AGiXT is a dynamic AI Agent Automation Platform that seamlessly orchestrates instruction management and complex task execution across diverse AI providers. Combining adaptive memory, smart features, and a versatile plugin system, AGiXT delivers efficient and comprehensive AI solutions.

**[geoai](https://github.com/opengeos/geoai)** (2,484 ⭐)
*Python*
GeoAI: Artificial Intelligence for Geospatial Data

**[LotteryAi](https://github.com/CorvusCodex/LotteryAi)** (137 ⭐)
*Python*
...
## 📰 AI Community News & Developments
...
**[raft](https://github.com/rapidsai/raft)** (979 ⭐)
*Cuda*
